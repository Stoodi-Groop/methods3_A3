...
singlepitch <- read.delim("Pitch/Study1D0S101T1_f0.txt")
...
newdata <- data %>%
  group_by(filename) %>% 
    summarize(meanTime=mean(V1), meanf0 = mean(V2), sdTime = sd(V1), sdf0 = sd(V2), IQRTime = IQR(V1), IQRf0 = IQR(V2))
